...
import com.emilia.pharmacy.form.mongoForms.OfficinalDrugForm;
...
@Controller
@RequestMapping("/ui/v1/mongoDB/officinal/drugs")
public class OfficinalDrugUIController {
    @Autowired
    ...
    String showOfficinalDrug(Model model) {
        List<Drug> officinalDrugs = service.sortOfficinal();
        SearchForm searchForm = new SearchForm();
        model.addAttribute("searchForm", searchForm);
        model.addAttribute("officinalDrugs", officinalDrugs);
        return "getAll/officinalDrugs-all";
    }
    ...
    public String search(Model model,
        ...
        List<Drug> officinalDrugs = service.search(word, service.sortOfficinal());
        model.addAttribute("searchForm", searchForm);
        model.addAttribute("officinalDrugs", officinalDrugs);
        return "getAll/officinalDrugs-all";
    }
    ...
    public String searchSorted(Model model,
                               @ModelAttribute("searchForm") SearchForm searchForm) {
        String word = searchForm.getString();
        List<Drug> list = service.search(word, service.sortOfficinal());
        model.addAttribute("searchForm", searchForm);
    ...
    public String delete(Model model, @PathVariable String id){
        service.delete(id);
        return "redirect:/ui/v1/mongoDB/officinal/drugs/";
    }

    @RequestMapping(value = "createForm", method = RequestMethod.GET)
    public String addOfficinalDrug(Model model){
        OfficinalDrugForm officinalDrugForm = new OfficinalDrugForm();
        ...
        Map<String, String> manufacturerMap = manufacturerService.getAll().stream()
        ...
        List<String> manufacturerList = manufacturerService.getAll().stream()
                .map(Manufacturer::getManufacturerName).collect(Collectors.toList());
        ...
        return "add/add-officinalDrug";
    }

    @RequestMapping(value = "endCreateForm", method = RequestMethod.POST)
    public String addOfficinalDrug(Model model, @ModelAttribute("form") OfficinalDrugForm form){

        Drug officinalDrug = new Drug();
        ...
        Manufacturer manufacturer = manufacturerService.getAll().stream()
                ...
                .findFirst().orElse(new Manufacturer());
    ...
    public String updateOfficinalDrug(Model model, @PathVariable("id") String id){
        Drug officinalDrug = service.get(id);
        OfficinalDrugForm officinalDrugForm = new OfficinalDrugForm();
    ...
    public String reviewOfficinalDrug(Model model, @PathVariable("id") String id){
        Drug officinalDrug = service.get(id);
        OfficinalDrugForm officinalDrugForm = new OfficinalDrugForm();
        ...
        model.addAttribute("manufacturerMap", manufacturerMap);
        model.addAttribute("manufacturerList", manufacturerList);
        return "review/review-officinalDrug";
    }

    @RequestMapping(value = "expireDrugs", method = RequestMethod.GET)
    String expireDrugs(Model model) {
        List<Drug> officinalDrugs = service.expireDrugs(LocalDate.now());
        SearchForm searchForm = new SearchForm();
        model.addAttribute("searchForm", searchForm);
        model.addAttribute("officinalDrugs", officinalDrugs);
        return "getAll/officinalDrugs-all";
    ...
    public String searchExpireDrugs(Model model,
                                              @ModelAttribute("searchForm") SearchForm searchForm) {
        String word = searchForm.getString();
        List<Drug> officinalDrugs = service.search(word, service.expireDrugs(LocalDate.now()));
        model.addAttribute("searchForm", searchForm);
        model.addAttribute("officinalDrugs", officinalDrugs);
        return "getAll/officinalDrugs-all";
    }
    ...
    String sortOfficinalNameAsce(Model model) {
        List<Drug> officinalDrugs = service.sortOfficinalNameAsce();
        SearchForm searchForm = new SearchForm();
        model.addAttribute("searchForm", searchForm);
        model.addAttribute("officinalDrugs", officinalDrugs);
        return "getAll/officinalDrugs-all";
    ...
    public String searchSortOfficinalNameAsce(Model model,
                                               @ModelAttribute("searchForm") SearchForm searchForm) {
        String word = searchForm.getString();
        List<Drug> officinalDrugs = service.search(word, service.sortOfficinalNameAsce());
        model.addAttribute("searchForm", searchForm);
        model.addAttribute("officinalDrugs", officinalDrugs);
        return "getAll/officinalDrugs-all";
    }
    ...
    String sortOfficinalNameDsce(Model model) {
        List<Drug> officinalDrugs = service.sortOfficinalNameDsce();
        SearchForm searchForm = new SearchForm();
        model.addAttribute("searchForm", searchForm);
        model.addAttribute("officinalDrugs", officinalDrugs);
        return "getAll/officinalDrugs-all";
    ...
    public String searchSortOfficinalNameDsce(Model model,
                                              @ModelAttribute("searchForm") SearchForm searchForm) {
        String word = searchForm.getString();
        List<Drug> officinalDrugs = service.search(word, service.sortOfficinalNameDsce());
        model.addAttribute("searchForm", searchForm);
        model.addAttribute("officinalDrugs", officinalDrugs);
        return "getAll/officinalDrugs-all";
    }
    ...
    String sortOfficinalCreatedAtAsce(Model model) {
        List<Drug> officinalDrugs = service.sortOfficinalCreatedAtAsce();
        SearchForm searchForm = new SearchForm();
        model.addAttribute("searchForm", searchForm);
        model.addAttribute("officinalDrugs", officinalDrugs);
        return "getAll/officinalDrugs-all";
    ...
    public String searchSortOfficinalCreatedAtAsce(Model model,
                                              @ModelAttribute("searchForm") SearchForm searchForm) {
        String word = searchForm.getString();
        List<Drug> officinalDrugs = service.search(word, service.sortOfficinalCreatedAtAsce());
        model.addAttribute("searchForm", searchForm);
        model.addAttribute("officinalDrugs", officinalDrugs);
        return "getAll/officinalDrugs-all";
    }
    ...
    String sortOfficinalCreatedAtDsce(Model model) {
        List<Drug> officinalDrugs = service.sortOfficinalCreatedAtDsce();
        SearchForm searchForm = new SearchForm();
        model.addAttribute("searchForm", searchForm);
        model.addAttribute("officinalDrugs", officinalDrugs);
        return "getAll/officinalDrugs-all";
    ...
    public String searchSortOfficinalCreatedAtDsce(Model model,
                                              @ModelAttribute("searchForm") SearchForm searchForm) {
        String word = searchForm.getString();
        List<Drug> officinalDrugs = service.search(word, service.sortOfficinalCreatedAtDsce());
        model.addAttribute("searchForm", searchForm);
        model.addAttribute("officinalDrugs", officinalDrugs);
        return "getAll/officinalDrugs-all";
    }
    ...
    String sortOfficinalUpdatedAtAsce(Model model) {
        List<Drug> officinalDrugs = service.sortOfficinalUpdatedAtAsce();
        SearchForm searchForm = new SearchForm();
        model.addAttribute("searchForm", searchForm);
        model.addAttribute("officinalDrugs", officinalDrugs);
        return "getAll/officinalDrugs-all";
    ...
    public String searchSortOfficinalUpdatedAtAsce(Model model,
                                                   @ModelAttribute("searchForm") SearchForm searchForm) {
        String word = searchForm.getString();
        List<Drug> officinalDrugs = service.search(word, service.sortOfficinalUpdatedAtAsce());
        model.addAttribute("searchForm", searchForm);
        model.addAttribute("officinalDrugs", officinalDrugs);
        return "getAll/officinalDrugs-all";
    }
    ...
    String sortOfficinalUpdatedAtDsce(Model model) {
        List<Drug> officinalDrugs = service.sortOfficinalUpdatedAtDsce();
        SearchForm searchForm = new SearchForm();
        model.addAttribute("searchForm", searchForm);
        model.addAttribute("officinalDrugs", officinalDrugs);
        return "getAll/officinalDrugs-all";
    ...
    public String searchSortOfficinalUpdatedAtDsce(Model model,
                                                   @ModelAttribute("searchForm") SearchForm searchForm) {
        String word = searchForm.getString();
        List<Drug> officinalDrugs = service.search(word, service.sortOfficinalUpdatedAtDsce());
        model.addAttribute("searchForm", searchForm);
        model.addAttribute("officinalDrugs", officinalDrugs);
        return "getAll/officinalDrugs-all";
    }
    ...
    String sortOfficinalUseExternal(Model model) {
        List<Drug> officinalDrugs = service.sortOfficinalUseExternal();
        SearchForm searchForm = new SearchForm();
        model.addAttribute("searchForm", searchForm);
        model.addAttribute("officinalDrugs", officinalDrugs);
        return "getAll/officinalDrugs-all";
    ...
    public String searchSortOfficinalUseExternal(Model model,
                                                   @ModelAttribute("searchForm") SearchForm searchForm) {
        String word = searchForm.getString();
        List<Drug> officinalDrugs = service.search(word, service.sortOfficinalUseExternal());
        model.addAttribute("searchForm", searchForm);
        model.addAttribute("officinalDrugs", officinalDrugs);
        return "getAll/officinalDrugs-all";
    }
    ...
    String sortOfficinalUseInternal(Model model) {
        List<Drug> officinalDrugs = service.sortOfficinalUseInternal();
        SearchForm searchForm = new SearchForm();
        model.addAttribute("searchForm", searchForm);
        model.addAttribute("officinalDrugs", officinalDrugs);
        return "getAll/officinalDrugs-all";
    ...
    public String searchSortOfficinalUseInternal(Model model,
                                                 @ModelAttribute("searchForm") SearchForm searchForm) {
        String word = searchForm.getString();
        List<Drug> officinalDrugs = service.search(word, service.sortOfficinalUseInternal());
        model.addAttribute("searchForm", searchForm);
        model.addAttribute("officinalDrugs", officinalDrugs);
        return "getAll/officinalDrugs-all";
    }
    ...
    String sortOfficinalUseExInternal(Model model) {
        List<Drug> officinalDrugs = service.sortOfficinalUseExInternal();
        SearchForm searchForm = new SearchForm();
        model.addAttribute("searchForm", searchForm);
        model.addAttribute("officinalDrugs", officinalDrugs);
        return "getAll/officinalDrugs-all";
    ...
    public String searchSortOfficinalUseExInternal(Model model,
                                                 @ModelAttribute("searchForm") SearchForm searchForm) {
        String word = searchForm.getString();
        List<Drug> officinalDrugs = service.search(word, service.sortOfficinalUseExInternal());
        model.addAttribute("searchForm", searchForm);
        model.addAttribute("officinalDrugs", officinalDrugs);
        return "getAll/officinalDrugs-all";
    }
    ...
    String sortOfficinalUseMix(Model model) {
        List<Drug> officinalDrugs = service.sortOfficinalUseMix();
        SearchForm searchForm = new SearchForm();
        model.addAttribute("searchForm", searchForm);
        model.addAttribute("officinalDrugs", officinalDrugs);
        return "getAll/officinalDrugs-all";
    ...
    public String searchSortOfficinalUseMix(Model model,
                                                   @ModelAttribute("searchForm") SearchForm searchForm) {
        String word = searchForm.getString();
        List<Drug> officinalDrugs = service.search(word, service.sortOfficinalUseMix());
        model.addAttribute("searchForm", searchForm);
        model.addAttribute("officinalDrugs", officinalDrugs);
        return "getAll/officinalDrugs-all";
    }
    ...
    String sortOfficinalFormTablets(Model model) {
        List<Drug> officinalDrugs = service.sortOfficinalFormTablets();
        SearchForm searchForm = new SearchForm();
        model.addAttribute("searchForm", searchForm);
        model.addAttribute("officinalDrugs", officinalDrugs);
        return "getAll/officinalDrugs-all";
    ...
    public String searchSortOfficinalFormTablets(Model model,
                                            @ModelAttribute("searchForm") SearchForm searchForm) {
        String word = searchForm.getString();
        List<Drug> officinalDrugs = service.search(word, service.sortOfficinalFormTablets());
        model.addAttribute("searchForm", searchForm);
        model.addAttribute("officinalDrugs", officinalDrugs);
        return "getAll/officinalDrugs-all";
    }
    ...
    String sortOfficinalFormOintment(Model model) {
        List<Drug> officinalDrugs = service.sortOfficinalFormOintment();
        SearchForm searchForm = new SearchForm();
        model.addAttribute("searchForm", searchForm);
        model.addAttribute("officinalDrugs", officinalDrugs);
        return "getAll/officinalDrugs-all";
    ...
    public String searchSortOfficinalFormOintment(Model model,
                                                 @ModelAttribute("searchForm") SearchForm searchForm) {
        String word = searchForm.getString();
        List<Drug> officinalDrugs = service.search(word, service.sortOfficinalFormOintment());
        model.addAttribute("searchForm", searchForm);
        model.addAttribute("officinalDrugs", officinalDrugs);
        return "getAll/officinalDrugs-all";
    }
    ...
    String sortOfficinalFormTincture(Model model) {
        List<Drug> officinalDrugs = service.sortOfficinalFormTincture();
        SearchForm searchForm = new SearchForm();
        model.addAttribute("searchForm", searchForm);
        model.addAttribute("officinalDrugs", officinalDrugs);
        return "getAll/officinalDrugs-all";
    ...
    public String searchSortOfficinalFormTincture(Model model,
                                                  @ModelAttribute("searchForm") SearchForm searchForm) {
        String word = searchForm.getString();
        List<Drug> officinalDrugs = service.search(word, service.sortOfficinalFormTincture());
        model.addAttribute("searchForm", searchForm);
        model.addAttribute("officinalDrugs", officinalDrugs);
        return "getAll/officinalDrugs-all";
    }
    ...
    String sortOfficinalInStockAsce(Model model) {
        List<Drug> officinalDrugs = service.sortOfficinalInStockAsce();
        SearchForm searchForm = new SearchForm();
        model.addAttribute("searchForm", searchForm);
        model.addAttribute("officinalDrugs", officinalDrugs);
        return "other/officinal-minimum-stock-asce";
    }
    ...
    public String searchSortOfficinalInStockAsce(Model model,
                                              @ModelAttribute("searchForm") SearchForm searchForm) {
        String word = searchForm.getString();
        List<Drug> officinalDrugs = service.search(word, service.sortOfficinalInStockAsce());
        model.addAttribute("searchForm", searchForm);
        model.addAttribute("officinalDrugs", officinalDrugs);
        return "other/officinal-minimum-stock-asce";
    }
    ...
    String sortOfficinalInStockDsce(Model model) {
        List<Drug> officinalDrugs = service.sortOfficinalInStockDsce();
        SearchForm searchForm = new SearchForm();
        model.addAttribute("searchForm", searchForm);
        model.addAttribute("officinalDrugs", officinalDrugs);
        return "other/officinal-minimum-stock-dsce";
    }
    ...
    public String searchSortOfficinalInStockDsce(Model model,
                                                 @ModelAttribute("searchForm") SearchForm searchForm) {
        String word = searchForm.getString();
        List<Drug> officinalDrugs = service.search(word, service.sortOfficinalInStockDsce());
        model.addAttribute("searchForm", searchForm);
        model.addAttribute("officinalDrugs", officinalDrugs);
        return "other/officinal-minimum-stock-dsce";
    }
    ...
    String sortOfficinalInStockAsceUseInternal(Model model) {
        List<Drug> officinalDrugs = service.sortOfficinalInStockAsceUseInternal();
        SearchForm searchForm = new SearchForm();
        model.addAttribute("searchForm", searchForm);
        model.addAttribute("officinalDrugs", officinalDrugs);
        return "other/officinal-minimum-stock-asce";
    ...
    public String searchSortOfficinalInStockAsceUseInternal(Model model,
                                                 @ModelAttribute("searchForm") SearchForm searchForm) {
        String word = searchForm.getString();
        List<Drug> officinalDrugs = service.search(word, service.sortOfficinalInStockAsceUseInternal());
        model.addAttribute("searchForm", searchForm);
        model.addAttribute("officinalDrugs", officinalDrugs);
        return "other/officinal-minimum-stock-asce";
    }
    ...
    String sortOfficinalInStockDsceUseInternal(Model model) {
        List<Drug> officinalDrugs = service.sortOfficinalInStockDsceUseInternal();
        SearchForm searchForm = new SearchForm();
        model.addAttribute("searchForm", searchForm);
        model.addAttribute("officinalDrugs", officinalDrugs);
        return "other/officinal-minimum-stock-dsce";
    ...
    public String searchSortOfficinalInStockDsceUseInternal(Model model,
                                                            @ModelAttribute("searchForm") SearchForm searchForm) {
        String word = searchForm.getString();
        List<Drug> officinalDrugs = service.search(word, service.sortOfficinalInStockDsceUseInternal());
        model.addAttribute("searchForm", searchForm);
        model.addAttribute("officinalDrugs", officinalDrugs);
        return "other/officinal-minimum-stock-dsce";
    }
    ...
    String sortOfficinalInStockAsceUseExternal(Model model) {
        List<Drug> officinalDrugs = service.sortOfficinalInStockAsceUseExternal();
        SearchForm searchForm = new SearchForm();
        model.addAttribute("searchForm", searchForm);
        model.addAttribute("officinalDrugs", officinalDrugs);
        return "other/officinal-minimum-stock-asce";
    ...
    public String searchSortOfficinalInStockAsceUseExternal(Model model,
                                                            @ModelAttribute("searchForm") SearchForm searchForm) {
        String word = searchForm.getString();
        List<Drug> officinalDrugs = service.search(word, service.sortOfficinalInStockAsceUseExternal());
        model.addAttribute("searchForm", searchForm);
        model.addAttribute("officinalDrugs", officinalDrugs);
        return "other/officinal-minimum-stock-asce";
    }
    ...
    public String searchSortOfficinalInStockDsceUseExternal(Model model,
                                                            @ModelAttribute("searchForm") SearchForm searchForm) {
        String word = searchForm.getString();
        List<Drug> officinalDrugs = service.search(word, service.sortOfficinalInStockDsceUseExternal());
        model.addAttribute("searchForm", searchForm);
        model.addAttribute("officinalDrugs", officinalDrugs);
        return "other/officinal-minimum-stock-dsce";
    }
    ...
    String sortOfficinalInStockAsceUseExternalInternal(Model model) {
        List<Drug> officinalDrugs = service.sortOfficinalInStockAsceUseExternalInternal();
        SearchForm searchForm = new SearchForm();
        model.addAttribute("searchForm", searchForm);
        model.addAttribute("officinalDrugs", officinalDrugs);
        return "other/officinal-minimum-stock-asce";
    ...
    public String searchSortOfficinalInStockAsceUseExternalInternal(Model model,
                                                            @ModelAttribute("searchForm") SearchForm searchForm) {
        String word = searchForm.getString();
        List<Drug> officinalDrugs = service.search(word, service.sortOfficinalInStockAsceUseExternalInternal());
        model.addAttribute("searchForm", searchForm);
        model.addAttribute("officinalDrugs", officinalDrugs);
        return "other/officinal-minimum-stock-asce";
    }
    ...
    String sortOfficinalInStockDsceUseExternalInternal(Model model) {
        List<Drug> officinalDrugs = service.sortOfficinalInStockDsceUseExternalInternal();
        SearchForm searchForm = new SearchForm();
        model.addAttribute("searchForm", searchForm);
        model.addAttribute("officinalDrugs", officinalDrugs);
        return "other/officinal-minimum-stock-dsce";
    ...
    public String searchSortOfficinalInStockDsceUseExternalInternal(Model model,
                                                                    @ModelAttribute("searchForm") SearchForm searchForm) {
        String word = searchForm.getString();
        List<Drug> officinalDrugs = service.search(word, service.sortOfficinalInStockDsceUseExternalInternal());
        model.addAttribute("searchForm", searchForm);
        model.addAttribute("officinalDrugs", officinalDrugs);
        return "other/officinal-minimum-stock-dsce";
    }
    ...
    String sortOfficinalInStockAsceUseMix(Model model) {
        List<Drug> officinalDrugs = service.sortOfficinalInStockAsceUseMix();
        SearchForm searchForm = new SearchForm();
        model.addAttribute("searchForm", searchForm);
        model.addAttribute("officinalDrugs", officinalDrugs);
        return "other/officinal-minimum-stock-asce";
    ...
    public String searchSortOfficinalInStockAsceUseMix(Model model,
                                                                    @ModelAttribute("searchForm") SearchForm searchForm) {
        String word = searchForm.getString();
        List<Drug> officinalDrugs = service.search(word, service.sortOfficinalInStockAsceUseMix());
        model.addAttribute("searchForm", searchForm);
        model.addAttribute("officinalDrugs", officinalDrugs);
        return "other/officinal-minimum-stock-asce";
    }
    ...
    public String searchSortOfficinalInStockDsceUseMix(Model model,
                                                       @ModelAttribute("searchForm") SearchForm searchForm) {
        String word = searchForm.getString();
        List<Drug> officinalDrugs = service.search(word, service.sortOfficinalInStockDsceUseMix());
        model.addAttribute("searchForm", searchForm);
        model.addAttribute("officinalDrugs", officinalDrugs);
        return "other/officinal-minimum-stock-dsce";
    }
    ...
    String sortOfficinalInStockAsceFormTablets(Model model) {
        List<Drug> officinalDrugs = service.sortOfficinalInStockAsceFormTablets();
        SearchForm searchForm = new SearchForm();
        model.addAttribute("searchForm", searchForm);
        model.addAttribute("officinalDrugs", officinalDrugs);
        return "other/officinal-minimum-stock-asce";
    ...
    public String searchSortOfficinalInStockAsceFormTablets(Model model,
                                                       @ModelAttribute("searchForm") SearchForm searchForm) {
        String word = searchForm.getString();
        List<Drug> officinalDrugs = service.search(word, service.sortOfficinalInStockAsceFormTablets());
        model.addAttribute("searchForm", searchForm);
        model.addAttribute("officinalDrugs", officinalDrugs);
        return "other/officinal-minimum-stock-asce";
    }
    ...
    String sortOfficinalInStockDsceFormTablets(Model model) {
        List<Drug> officinalDrugs = service.sortOfficinalInStockDsceFormTablets();
        SearchForm searchForm = new SearchForm();
        model.addAttribute("searchForm", searchForm);
        model.addAttribute("officinalDrugs", officinalDrugs);
        return "other/officinal-minimum-stock-dsce";
    ...
    public String searchSortOfficinalInStockDsceFormTablets(Model model,
                                                            @ModelAttribute("searchForm") SearchForm searchForm) {
        String word = searchForm.getString();
        List<Drug> officinalDrugs = service.search(word, service.sortOfficinalInStockDsceFormTablets());
        model.addAttribute("searchForm", searchForm);
        model.addAttribute("officinalDrugs", officinalDrugs);
        return "other/officinal-minimum-stock-dsce";
    }
    ...
    String sortOfficinalInStockAsceFormOintment(Model model) {
        List<Drug> officinalDrugs = service.sortOfficinalInStockAsceFormOintment();
        SearchForm searchForm = new SearchForm();
        model.addAttribute("searchForm", searchForm);
        model.addAttribute("officinalDrugs", officinalDrugs);
        return "other/officinal-minimum-stock-asce";
    ...
    public String searchSortOfficinalInStockAsceFormOintment(Model model,
                                                            @ModelAttribute("searchForm") SearchForm searchForm) {
        String word = searchForm.getString();
        List<Drug> officinalDrugs = service.search(word, service.sortOfficinalInStockAsceFormOintment());
        model.addAttribute("searchForm", searchForm);
        model.addAttribute("officinalDrugs", officinalDrugs);
        return "other/officinal-minimum-stock-asce";
    }
    ...
    String sortOfficinalInStockDsceFormOintment(Model model) {
        List<Drug> officinalDrugs = service.sortOfficinalInStockDsceFormOintment();
        SearchForm searchForm = new SearchForm();
        model.addAttribute("searchForm", searchForm);
        model.addAttribute("officinalDrugs", officinalDrugs);
        return "other/officinal-minimum-stock-dsce";
    ...
    public String searchSortOfficinalInStockDsceFormOintment(Model model,
                                                             @ModelAttribute("searchForm") SearchForm searchForm) {
        String word = searchForm.getString();
        List<Drug> officinalDrugs = service.search(word, service.sortOfficinalInStockDsceFormOintment());
        model.addAttribute("searchForm", searchForm);
        model.addAttribute("officinalDrugs", officinalDrugs);
        return "other/officinal-minimum-stock-dsce";
    }
    ...
    String sortOfficinalInStockAsceFormTincture(Model model) {
        List<Drug> officinalDrugs = service.sortOfficinalInStockAsceFormTincture();
        SearchForm searchForm = new SearchForm();
        model.addAttribute("searchForm", searchForm);
        model.addAttribute("officinalDrugs", officinalDrugs);
        return "other/officinal-minimum-stock-asce";
    ...
    public String searchSortOfficinalInStockAsceFormTincture(Model model,
                                                             @ModelAttribute("searchForm") SearchForm searchForm) {
        String word = searchForm.getString();
        List<Drug> officinalDrugs = service.search(word, service.sortOfficinalInStockAsceFormTincture());
        model.addAttribute("searchForm", searchForm);
        model.addAttribute("officinalDrugs", officinalDrugs);
        return "other/officinal-minimum-stock-asce";
    }
    ...
    String sortOfficinalInStockDsceFormTincture(Model model) {
        List<Drug> officinalDrugs = service.sortOfficinalInStockDsceFormTincture();
        SearchForm searchForm = new SearchForm();
        model.addAttribute("searchForm", searchForm);
        model.addAttribute("officinalDrugs", officinalDrugs);
        return "other/officinal-minimum-stock-dsce";
    ...
    public String searchSortOfficinalInStockDsceFormTincture(Model model,
                                                             @ModelAttribute("searchForm") SearchForm searchForm) {
        String word = searchForm.getString();
        List<Drug> officinalDrugs = service.search(word, service.sortOfficinalInStockDsceFormTincture());
        model.addAttribute("searchForm", searchForm);
        model.addAttribute("officinalDrugs", officinalDrugs);
        return "other/officinal-minimum-stock-dsce";
    }
