...
@Controller
@RequestMapping("/ui/v1/postgreeSQL/orders")
public class SQLOrderUIController {
    @Autowired
    ...
    String showAll(Model model) {
        List<SQLOrder> orders = service.getAll();
        SearchForm searchForm = new SearchForm();

        model.addAttribute("searchForm", searchForm);
        model.addAttribute("orders", orders);
        return "sqlPages/getAll/orders-all";
    }
    ...
    String sortNameDsce(Model model) {
        List<SQLOrder> orders = service.sortNameDsce();
        SearchForm searchForm = new SearchForm();
        model.addAttribute("searchForm", searchForm);
        model.addAttribute("orders", orders);
        return "sqlPages/getAll/orders-all";
    ...
    String sortPriceAsce(Model model) {
        List<SQLOrder> orders = service.sortPriceAsce();
        SearchForm searchForm = new SearchForm();
        model.addAttribute("searchForm", searchForm);
        model.addAttribute("orders", orders);
        return "sqlPages/getAll/orders-all";
    ...
    String sortPriceDsce(Model model) {
        List<SQLOrder> orders = service.sortPriceDsce();
        SearchForm searchForm = new SearchForm();
        model.addAttribute("searchForm", searchForm);
        model.addAttribute("orders", orders);
        return "sqlPages/getAll/orders-all";
    ...
    String sortQuantityAsce(Model model) {
        List<SQLOrder> orders = service.sortQuantityAsce();
        SearchForm searchForm = new SearchForm();
        model.addAttribute("searchForm", searchForm);
        model.addAttribute("orders", orders);
        return "sqlPages/getAll/orders-all";
    ...
    String sortQuantityDsce(Model model) {
        List<SQLOrder> orders = service.sortQuantityDsce();
        SearchForm searchForm = new SearchForm();
        model.addAttribute("searchForm", searchForm);
        model.addAttribute("orders", orders);
        return "sqlPages/getAll/orders-all";
    ...
    String sortCreatedAtAsce(Model model) {
        List<SQLOrder> orders = service.sortCreatedAtAsce();
        SearchForm searchForm = new SearchForm();
        model.addAttribute("searchForm", searchForm);
        model.addAttribute("orders", orders);
        return "sqlPages/getAll/orders-all";
    ...
    String sortCreatedAtDsce(Model model) {
        List<SQLOrder> orders = service.sortCreatedAtDsce();
        SearchForm searchForm = new SearchForm();
        model.addAttribute("searchForm", searchForm);
        model.addAttribute("orders", orders);
        return "sqlPages/getAll/orders-all";
    ...
    String sortUpdatedAtAsce(Model model) {
        List<SQLOrder> orders = service.sortUpdatedAtAsce();
        SearchForm searchForm = new SearchForm();
        model.addAttribute("searchForm", searchForm);
        model.addAttribute("orders", orders);
        return "sqlPages/getAll/orders-all";
    ...
    String sortUpdatedAtDsce(Model model) {
        List<SQLOrder> orders = service.sortUpdatedAtDsce();
        SearchForm searchForm = new SearchForm();
        model.addAttribute("searchForm", searchForm);
        model.addAttribute("orders", orders);
        return "sqlPages/getAll/orders-all";
    ...
    String sortStatusInprogress(Model model) {
        List<SQLOrder> orders = service.sortStatusInprogress();
        SearchForm searchForm = new SearchForm();
        model.addAttribute("searchForm", searchForm);
        model.addAttribute("orders", orders);
        return "sqlPages/getAll/orders-all";
    ...
    String sortStatusGone(Model model) {
        List<SQLOrder> orders = service.sortStatusGone();
        SearchForm searchForm = new SearchForm();
        model.addAttribute("searchForm", searchForm);
        model.addAttribute("orders", orders);
        return "sqlPages/getAll/orders-all";
    ...
    String sortStatusPending(Model model) {
        List<SQLOrder> orders = service.sortStatusPending();
        SearchForm searchForm = new SearchForm();
        model.addAttribute("searchForm", searchForm);
        model.addAttribute("orders", orders);
        return "sqlPages/getAll/orders-all";
    ...
    String sortTopTenDrugs(Model model) {
        List<SQLOrder> list = service.getAll();
        ...
        list = list.stream().sorted(Comparator.comparing(SQLOrder::getDrugQuantity).reversed()).limit(10)
                .collect(Collectors.toList());
        SearchForm searchForm = new SearchForm();
        model.addAttribute("searchForm", searchForm);
        model.addAttribute("orders", list);
        return "sqlPages/other/ten-most-popular-drugs";
    }
    ...
    String sortTopTenDrugsExtemporal(Model model) {
        List<SQLOrder> list = service.getAll().stream()
    ...
    public String sortCertainPeriod(Model model,
        ...
        model.addAttribute("orders", list);
        return "sqlPages/other/certaint-period-orders";
    }
    ...
    String sortTopTenClients(Model model) {
        ...
        list = list.stream().sorted(Comparator.comparing(SQLOrder::getPrice).reversed()).limit(10)
                .collect(Collectors.toList());

        SearchForm searchForm = new SearchForm();
        model.addAttribute("searchForm", searchForm);
        model.addAttribute("orders", list);
        return "sqlPages/other/ten-top-clients";
    }
