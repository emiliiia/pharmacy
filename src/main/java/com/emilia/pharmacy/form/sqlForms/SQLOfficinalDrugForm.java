...
/*
  ...
  @since 13.08.2022
*/
public class SQLOfficinalDrugForm {
    private Integer id;
    ...
    public SQLOfficinalDrugForm() {
    }

    public SQLOfficinalDrugForm(Integer id, LocalDateTime createdAt, LocalDateTime updatedAt, String description, String drugName, double volume, Use use, String prescript, ReleaseForm releaseForm, String officinalExpirationDate, double price, String manufacturerId, int officinalInStock) {
        this.id = id;
    ...
    public SQLOfficinalDrugForm(LocalDateTime createdAt, LocalDateTime updatedAt, String description, String drugName, double volume, Use use, String prescript, ReleaseForm releaseForm, String officinalExpirationDate, double price, String manufacturerId, int officinalInStock) {
        this.createdAt = createdAt;
        this.updatedAt = updatedAt;
        this.description = description;
        this.drugName = drugName;
