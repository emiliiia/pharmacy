    ...
    <ul class="dropdown">
        <li><a href="#">Sort By</a>
            <ul>
                <li><a href="">Name</a>
                    <ul>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/extemporal/drugs/sortExtemporalNameAsce">ascending&nbsp;&nbsp;&nbsp;▲</a></li>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/extemporal/drugs/sortExtemporalNameDsce">descending ▼</a></li>
                    </ul>
                </li>
                <li><a href="">Created at</a>
                    <ul>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/extemporal/drugs/sortExtemporalCreatedAtAsce">ascending&nbsp;&nbsp;&nbsp;▲</a></li>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/extemporal/drugs/sortExtemporalCreatedAtDsce">descending ▼</a></li>
                    </ul>
                </li>
                <li><a href="">Updated at</a>
                    <ul>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/extemporal/drugs/sortExtemporalUpdatedAtAsce">ascending&nbsp;&nbsp;&nbsp;▲</a></li>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/extemporal/drugs/sortExtemporalUpdatedAtDsce">descending ▼</a></li>
                    </ul>
                </li>
                <li><a href="">Use</a>
                    <ul>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/extemporal/drugs/sortExtemporalUseExternal">External</a></li>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/extemporal/drugs/sortExtemporalUseInternal">Internal</a></li>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/extemporal/drugs/sortExtemporalUseExInternal">External-Internal</a></li>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/extemporal/drugs/sortExtemporalUseMix">Mix</a></li>
                    </ul>
                </li>
                <li><a href="">Form</a>
                    <ul>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/extemporal/drugs/sortExtemporalFormTablets">Tablets</a></li>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/extemporal/drugs/sortExtemporalFormOintment">Ointment</a></li>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/extemporal/drugs/sortExtemporalFormPotion">Potion</a></li>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/extemporal/drugs/sortExtemporalFormAQUA">Aqua</a></li>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/extemporal/drugs/sortExtemporalFormFlour">Flour</a></li>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/extemporal/drugs/sortExtemporalFormTincture">Tincture</a></li>
                    </ul>
                </li>
            </ul>
        </li>
   ...
   <div class="titleComponentDIV">
    ...
    <table style="margin-top: -2px; margin-left: -55px;" class="table">
        ...
        <tr id="ququ" class="ququ2">
            ...
            <td><a style="font-size: 16px; color: #fedac4; text-decoration: none" href="http://localhost:8082/ui/v1/mongoDB/technologyBook/review/${drug.technologyId.id}">${drug.technologyId.type}</a></td>
            <td style="text-align: left"><#list drug.componentList as component>
            ...
            <td  style="background: #0f4040">
                <a style="position:absolute;" href="http://localhost:8082/ui/v1/mongoDB/extemporal/drugs/editForm/${drug.id}"><img id="rot" src="<@spring.url '/css/siteStyle/edit.png'/>" alt="" width="45" height="45"></a>
                <a style="margin-left: 50px;" href="http://localhost:8082/ui/v1/mongoDB/extemporal/drugs/delete/${drug.id}"><img id="rot" src="<@spring.url '/css/siteStyle/delete.png'/>" alt="" width="45" height="45"></a>
                <a style="position: relative; margin-left: 0px;" href="http://localhost:8082/ui/v1/mongoDB/extemporal/drugs/review/${drug.id}"><img id="rot" src="<@spring.url '/css/siteStyle/iconInform.png'/>" alt="" width="40" height="40"></a>
            </td>
        </tr>
        </#list>
        </tbody>
