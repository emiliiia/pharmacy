...
<div class="mainGroundwork">
        ...
        <li><a href="#">Sort By</a>
            <ul>
                <li><a href="">Drug name</a>
                    <ul>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/orders/officinal/sortOfficinalNameAsce">ascending&nbsp;&nbsp;&nbsp;▲</a></li>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/orders/officinal/sortOfficinalNameDsce">descending ▼</a></li>
                    </ul>
                </li>
                <li><a href="">Price</a>
                    <ul>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/orders/officinal/sortOfficinalPriceAsce">ascending&nbsp;&nbsp;&nbsp;▲</a></li>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/orders/officinal/sortOfficinalPriceDsce">descending ▼</a></li>
                    </ul>
                </li>
                <li><a href="">Quantity</a>
                    <ul>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/orders/officinal/sortOfficinalQuantityAsce">ascending&nbsp;&nbsp;&nbsp;▲</a></li>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/orders/officinal/sortOfficinalQuantityDsce">descending ▼</a></li>
                    </ul>
                </li>
                <li><a href="">Order Go</a>
                    <ul>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/orders/officinal/sortOfficinalOrderGoAsce">ascending&nbsp;&nbsp;&nbsp;▲</a></li>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/orders/officinal/sortOfficinalOrderGoDsce">descending ▼</a></li>
                    </ul>
                </li>
                <li><a href="">Created at</a>
                    <ul>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/orders/officinal/sortOfficinalCreatedAtAsce">ascending&nbsp;&nbsp;&nbsp;▲</a></li>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/orders/officinal/sortOfficinalCreatedAtDsce">descending ▼</a></li>
                    </ul>
                </li>
                <li><a href="">Updated at</a>
                    <ul>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/orders/officinal/sortOfficinalUpdatedAtAsce">ascending&nbsp;&nbsp;&nbsp;▲</a></li>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/orders/officinal/sortOfficinalUpdatedAtDsce">descending ▼</a></li>
                    </ul>
                </li>
            </ul>
        </li>
    ...
    <table style="margin-top: -2px" class="table">
        ...
        <tr id="ququ" class="ququ2">
            <td></td>
            <td><a style="font-size: 16px; color: #fedac4; text-decoration: none" href="http://localhost:8082/ui/v1/mongoDB/officinal/drugs/review/${order.drugId.id}">${order.drugId.drugName}</a></td>
            ...
            <td  style="background: #196a6a">
                <a style="position:absolute;" href="http://localhost:8082/ui/v1/mongoDB/orders/officinal/editForm/${order.id}"><img id="rot" src="<@spring.url '/css/siteStyle/edit.png'/>" alt="" width="45" height="45"></a>
                <a style="margin-left: 50px;" href="http://localhost:8082/ui/v1/mongoDB/orders/officinal/delete/${order.id}"><img id="rot" src="<@spring.url '/css/siteStyle/delete.png'/>" alt="" width="45" height="45"></a>
            </td>
        </tr>
        </#list>
        </tbody>
