...
<div class="mainGroundwork">
    ...
    <ul class="dropdown">
        <li><a href="#">Sort By</a>
            <ul>
                <li><a href="">Name</a>
                    <ul>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/officinal/drugs/sortOfficinalNameAsce">ascending&nbsp;&nbsp;&nbsp;▲</a></li>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/officinal/drugs/sortOfficinalNameDsce">descending ▼</a></li>
                    </ul>
                </li>
                <li><a href="">Created at</a>
                    <ul>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/officinal/drugs/sortOfficinalCreatedAtAsce">ascending&nbsp;&nbsp;&nbsp;▲</a></li>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/officinal/drugs/sortOfficinalCreatedAtDsce">descending ▼</a></li>
                    </ul>
                </li>
                <li><a href="">Updated at</a>
                    <ul>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/officinal/drugs/sortOfficinalUpdatedAtAsce">ascending&nbsp;&nbsp;&nbsp;▲</a></li>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/officinal/drugs/sortOfficinalUpdatedAtDsce">descending ▼</a></li>
                    </ul>
                </li>
                <li><a href="">Use</a>
                    <ul>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/officinal/drugs/sortOfficinalUseExternal">External</a></li>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/officinal/drugs/sortOfficinalUseInternal">Internal</a></li>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/officinal/drugs/sortOfficinalUseExInternal">External-Internal</a></li>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/officinal/drugs/sortOfficinalUseMix">Mix</a></li>
                    </ul>
                </li>
                <li><a href="">Form</a>
                    <ul>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/officinal/drugs/sortOfficinalFormTablets">Tablets</a></li>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/officinal/drugs/sortOfficinalFormOintment">Ointment</a></li>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/officinal/drugs/sortOfficinalFormTincture">Tincture</a></li>
                    </ul>
                </li>
                <li><a href="">In Stock</a>
                    <ul>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/officinal/drugs/sortOfficinalInStockAsce">ascending&nbsp;&nbsp;&nbsp;▲</a></li>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/officinal/drugs/sortOfficinalInStockDsce">descending ▼</a></li>
                    </ul>
                </li>
                <li><a href="http://localhost:8082/ui/v1/mongoDB/officinal/drugs/expireDrugs">Expired</a></li>
            </ul>
        </li>
    </ul>
    ...
    <table style="margin-top: -2px; margin-left: -55px;" class="table">
        ...
        <tr id="ququ" class="ququ2">
            ...
            <td>${drug.price} $</td>
            <td><a style="font-size: 16px; color: #fedac4; text-decoration: none" href="http://localhost:8082/ui/v1/mongoDB/manufacturers/review/${drug.manufacturerId.id}">${drug.manufacturerId.manufacturerName}</a></td>
