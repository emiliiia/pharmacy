        ...
        <li><a href="#">Sort By</a>
            <ul>
                <li><a href="">Drug name</a>
                    <ul>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/orders/sortNameAsce">ascending&nbsp;&nbsp;&nbsp;▲</a></li>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/orders/sortNameDsce">descending ▼</a></li>
                    </ul>
                </li>
                <li><a href="">Price</a>
                    <ul>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/orders/sortPriceAsce">ascending&nbsp;&nbsp;&nbsp;▲</a></li>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/orders/sortPriceDsce">descending ▼</a></li>
                    </ul>
                </li>
                <li><a href="">Quantity</a>
                    <ul>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/orders/sortQuantityAsce">ascending&nbsp;&nbsp;&nbsp;▲</a></li>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/orders/sortQuantityDsce">descending ▼</a></li>
                    </ul>
                </li>
                <li><a href="">Order Go</a>
                    <ul>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/orders/sortOrderGoAsce">ascending&nbsp;&nbsp;&nbsp;▲</a></li>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/orders/sortOrderGoDsce">descending ▼</a></li>
                    </ul>
                </li>
                <li><a href="">Created at</a>
                    <ul>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/orders/sortCreatedAtAsce">ascending&nbsp;&nbsp;&nbsp;▲</a></li>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/orders/sortCreatedAtDsce">descending ▼</a></li>
                    </ul>
                </li>
                <li><a href="">Updated at</a>
                    <ul>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/orders/sortUpdatedAtAsce">ascending&nbsp;&nbsp;&nbsp;▲</a></li>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/orders/sortUpdatedAtDsce">descending ▼</a></li>
                    </ul>
                </li>
                <li><a href="#">Status</a>
                    <ul>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/orders/sortStatusInprogress">In Progress</a></li>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/orders/sortStatusGone">Gone</a></li>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/orders/sortStatusPending">Pending</a></li>
                    </ul>
                </li>
            </ul>
        </li>
    ...
    <table style="margin-top: -2px" class="table">
        ...
        <tr id="ququ" class="ququ2">
            ...
            <td  style="background: #196a6a">
              <a style="margin-left: 0px;" href="http://localhost:8082/ui/v1/mongoDB/orders/delete/${order.id}"><img id="rot" src="<@spring.url '/css/siteStyle/delete.png'/>" alt="" width="45" height="45"></a>
            </td>
        </tr>
        </#list>
        </tbody>
