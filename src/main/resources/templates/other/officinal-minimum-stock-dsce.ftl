    ...
    <ul class="dropdown">
        <li><a href="#">Dsce</a>
            <ul>
                <li><a href="">Use</a>
                    <ul>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/officinal/drugs/sortOfficinalInStockDsce/UseExternal">External</a></li>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/officinal/drugs/sortOfficinalInStockDsce/UseInternal">Internal</a></li>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/officinal/drugs/sortOfficinalInStockDsce/UseExternalInternal">External-Internal</a></li>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/officinal/drugs/sortOfficinalInStockDsce/UseMix">Mix</a></li>
                    </ul>
                </li>
                <li><a href="">Form</a>
                    <ul>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/officinal/drugs/sortOfficinalInStockDsce/FormTablets">Tablets</a></li>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/officinal/drugs/sortOfficinalInStockDsce/FormOintment">Ointment</a></li>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/officinal/drugs/sortOfficinalInStockDsce/FormTincture">Tincture</a></li>
                    </ul>
                </li>
            </ul>
        </li>
