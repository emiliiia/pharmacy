    ...
    <ul class="dropdown">
        <li><a href="#">Top-10</a>
            <ul>
                <li><a href="">Type</a>
                    <ul>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/orders/sortTopTenDrugs/extemporal">Extemporal</a></li>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/orders/sortTopTenDrugs/officinal">Officinal</a></li>
                    </ul>
                </li>
                <li><a href="">Use</a>
                    <ul>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/orders/sortTopTenDrugs/sortUseExternal">External</a></li>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/orders/sortTopTenDrugs/sortUseInternal">Internal</a></li>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/orders/sortTopTenDrugs/sortUseExternalInternal">External-Internal</a></li>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/orders/sortTopTenDrugs/sortUseMix">Mix</a></li>
                    </ul>
                </li>
                <li><a href="">Release Form</a>
                    <ul>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/orders/sortTopTenDrugs/sortFormTablets">Tablets</a></li>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/orders/sortTopTenDrugs/sortFormOintment">Ointment</a></li>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/orders/sortTopTenDrugs/sortFormPotion">Potion</a></li>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/orders/sortTopTenDrugs/sortFormAqua">Aqua</a></li>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/orders/sortTopTenDrugs/sortFormFlour">Flour</a></li>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/orders/sortTopTenDrugs/sortFormTincture">Tincture</a></li>
                    </ul>
                </li>
            </ul>
        </li>
