...
<div class="mainGroundwork">
    ...
    <ul class="dropdown">
        <li><a href="#">Sort By</a>
            <ul>
                <li><a href="">Type</a>
                    <ul>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/orders/sortTopTenClients/sortExtemporal">Extemporal</a></li>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/orders/sortTopTenClients/sortOfficinal">Officinal</a></li>
                    </ul>
                </li>
                <li><a href="">Use</a>
                    <ul>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/orders/sortTopTenClients/sortUseExternal">External</a></li>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/orders/sortTopTenClients/sortUseInternal">Internal</a></li>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/orders/sortTopTenClients/sortUseExternalInternal">External-Internal</a></li>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/orders/sortTopTenClients/sortUseMix">Mix</a></li>
                    </ul>
                </li>
                <li><a href="">Release Form</a>
                    <ul>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/orders/sortTopTenClients/sortFormTablets">Tablets</a></li>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/orders/sortTopTenClients/sortFormOintment">Ointment</a></li>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/orders/sortTopTenClients/sortFormPotion">Potion</a></li>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/orders/sortTopTenClients/sortFormAqua">Aqua</a></li>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/orders/sortTopTenClients/sortFormFlour">Flour</a></li>
                        <li><a href="http://localhost:8082/ui/v1/mongoDB/orders/sortTopTenClients/sortFormTincture">Tincture</a></li>
                    </ul>
                </li>
            </ul>
        </li>
    ...
    <br><br><br><br><br>
    <a style="height: 45px;margin-left:1150px" id="addIcon" href="http://localhost:8082/ui/v1/mongoDB/clients/createForm"><img style="" id="rot" src="<@spring.url '/css/siteStyle/iconAdd.png'/>" alt="Add Component" width="45" height="45"></a>
