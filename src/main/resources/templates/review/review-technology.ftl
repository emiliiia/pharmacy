...
<div class="mainGroundwork">
    ...
    <div class="titleComponentDIV">
        <h1 id="titleComponent">Technology</h1>
    </div>
    <div style="height: 500px" class="AddContainer">
        <div class="brand-logoTechnologyBook"></div>
        <div class="brand-title">Technology</div>
        <form name="technology" action="" method="get">
            <div class="inputs">
                <label>TYPE</label>
                <@spring.formInput "form.type" "readonly" />
                <label>METHOD</label>
                <div class="select">
                    <@spring.formInput "form.method", "readonly"/>
                </div>
                <label>TIME TO READY</label>
                <@spring.formInput "form.timeReady" "readonly" />
            </div>
        </form>
    </div>
</div>
