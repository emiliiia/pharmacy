...
<div class="mainGroundwork">
    ...
    <div class="titleComponentDIV">
        <h1 id="titleComponent">Update component form</h1>
    </div>
    <div style="height: 720px" class="AddContainer">
        ...
        <form name="component" action="" method="post">
            <div class="inputs">
                <label>NAME</label>
                <@spring.formInput "form.componentName" "text" />
                <label>MEASURE</label>
                <@spring.formInput "form.measure" "text" />
                <label>CRITICAL NORM</label>
                <@spring.formInput "form.criticalNorm" "number"/>
                <label>IN STOCK</label>
                <@spring.formInput "form.inStock" "number"/>
                <label>PRICE</label>
                <@spring.formInput "form.price" "0.0" "number"/>
                <form action="">
