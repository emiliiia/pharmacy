...
<div class="mainGroundwork">
    ...
    <div class="titleComponentDIV">
        <h1 id="titleComponent">Update manufacturer form</h1>
    </div>
    <div style="height: 650px" class="AddContainer">
        <div class="brand-logoManufacturer"></div>
        <div class="brand-title">Manufacturer</div>
        <form name="manufacturer" action="" method="post">
            <div class="inputs">
                <label>NAME</label>
                <@spring.formInput "form.manufacturerName" "text" />
                <label>AGENT NAME</label>
                <@spring.formInput "form.agentName" "placeholder='Surname Name'" "text" />
                <label>PHONE</label>
