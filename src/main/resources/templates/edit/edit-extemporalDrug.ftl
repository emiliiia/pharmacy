    ...
    <div style="height: 1000px; width: 1000px" class="AddContainer">
        ...
        <form name="extemporalDrug" action="" method="post">
            <div class="inputs">
                ...
                <form action="">
                    <button type="submit">UPDATE EXTEMPORAL DRUG</button>
                </form>
                ...
                <div style="height: 750px; width: 400px; margin-left: 490px; margin-top: -780px;">
                    ...
                    <div>
                        <@spring.formMultiSelect "form.componentList", componentMap "selected"/>
                    </div>
                </div>
            </div>
        </form>
