    ...
    <div style="height: 650px" class="AddContainer">
        ...
        <form name="manufacturer" action="endCreateForm" method="post">
            <div class="inputs">
                ...
                <label>PHONE</label>
                <@spring.formInput "form.agentPhNum" "placeholder='+XXX0000000000'" "text"/>
                <label>COUNTRY</label>
                <@spring.formInput "form.country" "required" "placeholder='USA'"/>
                <form action="http://localhost:8082/ui/v1/mongoDB/manufacturers/endCreateForm">
