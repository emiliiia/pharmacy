...
<div class="mainGroundwork">
  ...
  <div style="height: 720px" class="AddContainer">
    ...
    <form name="component" action="endCreateForm" method="post">
      <div class="inputs">
        <label>NAME</label>
        <@spring.formInput "form.componentName" "placeholder='Component name'" "text" />
        <label>MEASURE</label>
        <@spring.formInput "form.measure" "placeholder='kg/l'" "text" />
        <label>CRITICAL NORM</label>
        <@spring.formInput "form.criticalNorm" "step=0.01" "number"/>
        <label>IN STOCK</label>
        <@spring.formInput "form.inStock" "number"/>
        <label>PRICE</label>
        <@spring.formInput "form.price" "step=0.01" "number"/>
        <form action="http://localhost:8082/ui/v1/mongoDB/components/endCreateForm">
