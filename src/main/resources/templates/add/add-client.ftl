...
<div class="mainGroundwork">
    ...
    <div class="titleComponentDIV">
        <h1 id="titleComponent">Add client form</h1>
    </div>
    <div class="AddContainer">
        <div class="brand-logoClient"></div>
        <div class="brand-title">Client</div>
        <form name="client" action="endCreateForm" method="post">
            <div class="inputs">
                <label>NAME</label>
                <@spring.formInput "form.clientName" "placeholder='Surname Name'" "text" />
                <label>PHONE</label>
                <@spring.formInput "form.clientPhNum" "placeholder='+380*********'" "text" />
                <label>EMAIL</label>
                <@spring.formInput "form.clientEmail" "placeholder='name@gmail.com'" "text"/>
                <label>DATE OF BIRTH</label>
                <@spring.formInput "form.clientDateBirth" "placeholder='yyyy-mm-dd'" "date"/>
                <form action="http://localhost:8082/ui/v1/mongoDB/clients/endCreateForm">
