...
<div class="mainGroundwork">
    ...
    <div class="titleComponentDIV">
        <h1 id="titleComponent">Officinal drug</h1>
    </div>
    <div style="height: 1250px" class="AddContainer">
        <div class="brand-logoOfficinal"></div>
        <div class="brand-title">Officinal Drug</div>
        <form name="officinalDrug" action="" method="get">
            <div class="inputs">
                <label>NAME</label>
                <@spring.formInput "form.drugName" "readonly" />
                <label>IN STOCK</label>
                <@spring.formInput "form.officinalInStock", "readonly"/>
                <label>VOLUME</label>
                ...
                <@spring.formInput "form.officinalExpirationDate", "readonly" />
                <label>MANUFACTURER</label>
                <@spring.formInput "form.manufacturerId" "readonly"/>
                <label>PRICE</label>
