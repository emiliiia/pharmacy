...
<div class="mainGroundwork">
    ...
    <div class="titleComponentDIV">
        <h1 id="titleComponent">Client</h1>
    </div>
    <div style="height: 580px" class="AddContainer">
        ...
        <form name="client" action="" method="post">
            <div class="inputs">
                <label>NAME</label>
                <@spring.formInput "form.clientName" "readonly" />
                <label>PHONE</label>
                <@spring.formInput "form.clientPhNum" "readonly" />
                <label>EMAIL</label>
                <@spring.formInput "form.clientEmail" "readonly"/>
                <label>DATE OF BIRTH</label>
                <@spring.formInput "form.clientDateBirth" "placeholder='yyyy-mm-dd'" "readonly"/>
            </div>
        </form>
    </div>
</div>
