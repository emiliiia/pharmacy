...
<div class="mainGroundwork">
    ...
    <div class="titleComponentDIV">
        <h1 id="titleComponent">Manufacturer</h1>
    </div>
    <div style="height: 580px" class="AddContainer">
        <div class="brand-logoManufacturer"></div>
        <div class="brand-title">Manufacturer</div>
        <form name="manufacturer" action="" method="get">
            <div class="inputs">
                <label>NAME</label>
                <@spring.formInput "form.manufacturerName" "readonly" />
                <label>AGENT NAME</label>
                <@spring.formInput "form.agentName" "readonly" "placeholder='Surname Name'" />
                <label>PHONE</label>
                <@spring.formInput "form.agentPhNum" "placeholder='+XXX0000000000'" "readonly"/>
                <label>COUNTRY</label>
                <@spring.formInput "form.country" "readonly" "placeholder='USA'"/>
