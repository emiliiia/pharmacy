...
<div class="mainGroundwork">
    ...
    <div class="titleComponentDIV">
        <h1 id="titleComponent">Add request for component form</h1>
    </div>
    <div style="height: 550px" class="AddContainer">
        <div class="brand-logoRequestComponent"></div>
        <div class="brand-title">Request</div>
        <form name="requestComponent" action="endCreateForm" method="post">
            <div class="inputs">
                ...
                <label>STATUS</label>
                <div class="select">
                    <@spring.formSingleSelect "form.status", status "select"/>
                </div>
                <label>QUANTITY</label>
                <@spring.formInput "form.requestQuantity" "required" "number" />
                <form action="http://localhost:8082/ui/v1/postgreeSQL/requestComponents/endCreateForm">
