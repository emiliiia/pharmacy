...
<div class="mainGroundwork">
    ...
    <div class="titleComponentDIV">
        <h1 id="titleComponent">Add component form</h1>
    </div>
    <div style="height: 720px" class="AddContainer">
        <div class="brand-logoComponent"></div>
        <div class="brand-title">Component</div>
        <form name="component" action="endCreateForm" method="post">
            <div class="inputs">
                <label>NAME</label>
                <@spring.formInput "form.componentName" "required" "placeholder='Component name'" />
                <label>MEASURE</label>
                <@spring.formInput "form.measure" "required" "placeholder='kg/l'" />
                <label>CRITICAL NORM</label>
                <@spring.formInput "form.criticalNorm" "step=0.01" "number"/>
                <label>IN STOCK</label>
                <@spring.formInput "form.inStock" "step=1" "number"/>
                <label>PRICE</label>
                <@spring.formInput "form.price" "step=0.01" "number"/>
                <form action="http://localhost:8082/ui/v1/postgreeSQL/components/endCreateForm">
