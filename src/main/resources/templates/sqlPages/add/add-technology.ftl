...
<div class="mainGroundwork">
    ...
    <div class="titleComponentDIV">
        <h1 id="titleComponent">Add technology form</h1>
    </div>
    <div style="height: 550px" class="AddContainer">
        <div class="brand-logoTechnologyBook"></div>
        <div class="brand-title">Technology</div>
        <form name="technology" action="endCreateForm" method="post">
            <div class="inputs">
                <label>TYPE</label>
                <@spring.formInput "form.type" "required" "text" />
                <label>METHOD</label>
                <div class="select">
                    <@spring.formSingleSelect "form.method", methods "select"/>
                </div>
                <label>TIME TO READY</label>
                <@spring.formInput "form.timeReady" "required" "text" />
                <form action="http://localhost:8082/ui/v1/postgreeSQL/technologyBook/endCreateForm">
                    <button type="submit">ADD NEW TECHNOLOGY</button>
                </form>
            </div>
        </form>
    </div>
