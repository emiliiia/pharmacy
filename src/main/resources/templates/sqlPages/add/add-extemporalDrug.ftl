...
<div class="mainGroundwork">
    ...
    <div style="height: 1100px;" class="AddContainer">
        ...
        <form name="extemporalDrug" action="endCreateForm" method="post">
            <div class="inputs">
                ...
                <div class="select">
                    <@spring.formSingleSelect "form.componentId", componentList "select"/>
                </div>
                <form action="http://localhost:8082/ui/v1/postgreeSQL/extemporal/drugs/endCreateForm">
