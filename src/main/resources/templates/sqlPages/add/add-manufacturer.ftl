...
<div class="mainGroundwork">
    ...
    <div class="titleComponentDIV">
        <h1 id="titleComponent">Add manufacturer form</h1>
    </div>
    <div style="height: 650px" class="AddContainer">
        <div class="brand-logoManufacturer"></div>
        <div class="brand-title">Manufacturer</div>
        <form name="manufacturer" action="endCreateForm" method="post">
            <div class="inputs">
                <label>NAME</label>
                <@spring.formInput "form.manufacturerName" "required" />
                <label>AGENT NAME</label>
                <@spring.formInput "form.agentName" "required" "placeholder='Surname Name'" />
                <label>PHONE</label>
                <@spring.formInput "form.agentPhNum" "required" "placeholder='+XXX0000000000'"/>
                <label>COUNTRY</label>
                <@spring.formInput "form.country" "placeholder='USA'" "text"/>
                <form action="http://localhost:8082/ui/v1/postgreeSQL/manufacturers/endCreateForm">
