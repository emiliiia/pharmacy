...
<div class="mainGroundwork">
    ...
    <div class="AddContainer">
        ...
        <form name="client" action="endCreateForm" method="post">
            <div class="inputs">
                <label>NAME</label>
                <@spring.formInput "form.clientName" "required" "max-length = 30" />
                <label>PHONE</label>
                ...
                <@spring.formInput "form.clientDateBirth" "required" "date"/>
                <form action="http://localhost:8082/ui/v1/postgreeSQL/clients/endCreateForm">
