...
<div class="mainGroundwork">
    ...
    <div style="height: 820px" class="AddContainer">
        <div class="brand-logoOrder"></div>
        <div class="brand-title">Officinal Order</div>
        <form name="officinalOrder" action="endCreateForm" method="post">
            <div class="inputs">
                <label>DRUG</label>
                <div class="select">
                ...
                <form action="http://localhost:8082/ui/v1/postgreeSQL/orders/officinal/endCreateForm">
