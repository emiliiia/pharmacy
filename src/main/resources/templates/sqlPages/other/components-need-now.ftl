...
<div class="mainGroundwork">
    ...
    <ul class="dropdown">
        <li><a href="#">Sort By</a>
            <ul>
                <li><a href="">Name</a>
                    <ul>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/components/sortNameAsce">ascending&nbsp;&nbsp;&nbsp;▲</a></li>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/components/sortNameDsce">descending ▼</a></li>
                    </ul>
                </li>
                <li><a href="">Created at</a>
                    <ul>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/components/sortCreatedAtAsce">ascending&nbsp;&nbsp;&nbsp;▲</a></li>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/components/sortCreatedAtDsce">descending ▼</a></li>
                    </ul>
                </li>
                <li><a href="">Updated at</a>
                    <ul>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/components/sortUpdatedAtAsce">ascending&nbsp;&nbsp;&nbsp;▲</a></li>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/components/sortUpdatedAtDsce">descending ▼</a></li>
                    </ul>
                </li>
                <li><a href="#">Measure</a>
                    <ul>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/components/sortMeasureKg">kg</a></li>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/components/sortMeasureL">l</a></li>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/components/sortMeasureMG">mg</a></li>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/components/sortMeasureML">ml</a></li>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/components/sortMeasureG">g</a></li>
                    </ul>
                </li>
                <li><a href="http://localhost:8082/ui/v1/postgreeSQL/components/needComponent">Lack</a></li>
                <li><a href="http://localhost:8082/ui/v1/postgreeSQL/orders/extemporal/needComponentNow">Needed now</a></li>
                <li><a href="http://localhost:8082/ui/v1/postgreeSQL/orders/extemporal/UsedComponents">Used</a></li>
            </ul>
        </li>
    </ul>
    <br><br><br><br><br>
    <a style="height: 45px;margin-left:1150px" id="addIcon" href="http://localhost:8082/ui/v1/postgreeSQL/components/createForm"><img style="" id="rot" src="<@spring.url '/css/siteStyle/iconAdd.png'/>" alt="Add Request" width="0" height="0"></a>
    <div class="titleComponentDIV">
        <h1 id="titleComponent">Component needs now table</h1>
    </div>
    <table style="margin-top: -2px" class="table">
        ...
        <tr id="ququ" class="ququ2">
            <td></td>
            <td><a style="font-size: 16px; color: #fedac4; text-decoration: none" href="http://localhost:8082/ui/v1/postgreeSQL/components/review/${order.drugId.componentId.id}">${order.drugId.componentId.componentName}</a></td>
            <td>${order.drugId.componentId.measure}</td>
            <td>${order.drugId.componentId.inStock}</td>
            <td>${order.drugId.componentId.criticalNorm}</td>
            <td>${order.drugId.componentId.price} $</td>
            <td  style="background: #196a6a">
                <a style="position:absolute;" href="http://localhost:8082/ui/v1/postgreeSQL/components/editForm/${order.drugId.componentId.id}"><img id="rot" src="<@spring.url '/css/siteStyle/edit.png'/>" alt="" width="45" height="45"></a>
                <a style="margin-left: 50px;" href="http://localhost:8082/ui/v1/postgreeSQL/components/delete/${order.drugId.componentId.id}"><img id="rot" src="<@spring.url '/css/siteStyle/delete.png'/>" alt="" width="45" height="45"></a>
            </td>
        </tr>
        </#list>
        </tbody>
