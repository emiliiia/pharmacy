...
<div class="mainGroundwork">
    ...
    <ul class="dropdown">
        <li><a href="#">Dsce</a>
            <ul>
                <li><a href="">Use</a>
                    <ul>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/officinal/drugs/sortOfficinalInStockDsce/UseExternal">External</a></li>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/officinal/drugs/sortOfficinalInStockDsce/UseInternal">Internal</a></li>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/officinal/drugs/sortOfficinalInStockDsce/UseExternalInternal">External-Internal</a></li>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/officinal/drugs/sortOfficinalInStockDsce/UseMix">Mix</a></li>
                    </ul>
                </li>
                <li><a href="">Form</a>
                    <ul>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/officinal/drugs/sortOfficinalInStockDsce/FormTablets">Tablets</a></li>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/officinal/drugs/sortOfficinalInStockDsce/FormOintment">Ointment</a></li>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/officinal/drugs/sortOfficinalInStockDsce/FormTincture">Tincture</a></li>
                    </ul>
                </li>
            </ul>
        </li>
    ...
    <table style="margin-top: -2px; margin-left: -55px;" class="table">
        ...
        <tr id="ququ" class="ququ2">
            ...
            <td>${drug.price} $</td>
            <td><a style="font-size: 16px; color: #fedac4; text-decoration: none" href="http://localhost:8082/ui/v1/postgreeSQL/officinal/manufacturers/review/${drug.manufacturerId.id}">${drug.manufacturerId.manufacturerName}</a></td>
