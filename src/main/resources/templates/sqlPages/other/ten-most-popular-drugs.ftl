...
<div class="mainGroundwork">
    ...
    <ul class="dropdown">
        <li><a href="#">Top-10</a>
            <ul>
                <li><a href="">Type</a>
                    <ul>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/orders/sortTopTenDrugs/extemporal">Extemporal</a></li>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/orders/sortTopTenDrugs/officinal">Officinal</a></li>
                    </ul>
                </li>
                <li><a href="">Use</a>
                    <ul>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/orders/sortTopTenDrugs/sortUseExternal">External</a></li>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/orders/sortTopTenDrugs/sortUseInternal">Internal</a></li>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/orders/sortTopTenDrugs/sortUseExternalInternal">External-Internal</a></li>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/orders/sortTopTenDrugs/sortUseMix">Mix</a></li>
                    </ul>
                </li>
                <li><a href="">Release Form</a>
                    <ul>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/orders/sortTopTenDrugs/sortFormTablets">Tablets</a></li>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/orders/sortTopTenDrugs/sortFormOintment">Ointment</a></li>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/orders/sortTopTenDrugs/sortFormPotion">Potion</a></li>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/orders/sortTopTenDrugs/sortFormAqua">Aqua</a></li>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/orders/sortTopTenDrugs/sortFormFlour">Flour</a></li>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/orders/sortTopTenDrugs/sortFormTincture">Tincture</a></li>
                    </ul>
                </li>
            </ul>
        </li>
    ...
    <div class="titleComponentDIV">
        <h1 id="titleComponent">Top-10 drugs</h1>
    </div>
    <table style="margin-top: -2px" class="table">
        <thead>
        <tr>
            <th>№</th>
            <th style="padding-left: 70px; padding-right: 70px;">Drug Name</th>
            <th>Quantity</th>
            <th>Use</th>
            <th>Volume</th>
            <th>Release form</th>
        ...
        <tr id="ququ">
            ...
            <td>${order.drugId.use}</td>
            <td>${order.drugId.volume}</td>
            <td>${order.drugId.releaseForm}</td>
            <td>${order.drugId.price} $</td>
        </tr>
        </#list>
        </tbody>
    </table>
