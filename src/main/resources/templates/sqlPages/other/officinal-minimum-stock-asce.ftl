    ...
    <ul class="dropdown">
        <li><a href="#">Asce</a>
            <ul>
                <li><a href="">Use</a>
                    <ul>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/officinal/drugs/sortOfficinalInStockAsce/UseExternal">External</a></li>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/officinal/drugs/sortOfficinalInStockAsce/UseInternal">Internal</a></li>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/officinal/drugs/sortOfficinalInStockAsce/UseExternalInternal">External-Internal</a></li>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/officinal/drugs/sortOfficinalInStockAsce/UseMix">Mix</a></li>
                    </ul>
                </li>
                <li><a href="">Form</a>
                    <ul>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/officinal/drugs/sortOfficinalInStockAsce/FormTablets">Tablets</a></li>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/officinal/drugs/sortOfficinalInStockAsce/FormOintment">Ointment</a></li>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/officinal/drugs/sortOfficinalInStockAsce/FormTincture">Tincture</a></li>
                    </ul>
                </li>
            </ul>
        </li>
