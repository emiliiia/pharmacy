...
<div class="mainGroundwork">
        ...
        <li><a href="#">Sort By</a>
            <ul>
                <li><a href="">Drug name</a>
                    <ul>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/orders/extemporal/clientsWait/sortClientWaitDrugNameAsce">ascending&nbsp;&nbsp;&nbsp;▲</a></li>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/orders/extemporal/clientsWait/sortClientWaitDrugNameDsce">descending ▼</a></li>
                    </ul>
                </li>
                <li><a href="">Client name</a>
                    <ul>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/orders/extemporal/clientsWait/sortClientWaitClientNameAsce">ascending&nbsp;&nbsp;&nbsp;▲</a></li>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/orders/extemporal/clientsWait/sortClientWaitClientNameDsce ">descending ▼</a></li>
                    </ul>
                </li>
                <li><a href="">Use</a>
                    <ul>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/orders/extemporal/clientsWait/sortClientWaitUseExternal">External</a></li>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/orders/extemporal/clientsWait/sortClientWaitUseInternal">Internal</a></li>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/orders/extemporal/clientsWait/sortClientWaitUseExternalInternal">External-Internal</a></li>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/orders/extemporal/clientsWait/sortClientWaitUseMix">Mix</a></li>
                    </ul>
                </li>
                <li><a href="">Release Form</a>
                    <ul>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/orders/extemporal/clientsWait/sortClientWaitFormTablets">Tablets</a></li>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/orders/extemporal/clientsWait/sortClientWaitFormOintment">Ointment</a></li>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/orders/extemporal/clientsWait/sortClientWaitFormPotion">Potion</a></li>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/orders/extemporal/clientsWait/sortClientWaitFormAqua">Aqua</a></li>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/orders/extemporal/clientsWait/sortClientWaitFormFlour">Flour</a></li>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/orders/extemporal/clientsWait/sortClientWaitFormTincture">Tincture</a></li>
                    </ul>
                </li>
            </ul>
        </li>
    ...
    <br><br><br><br><br>
    <a style="height: 45px;margin-left:1150px" id="addIcon" href="http://localhost:8082/ui/v1/postgreeSQL/clients/createForm"><img style="" id="rot" src="<@spring.url '/css/siteStyle/iconAdd.png'/>" alt="Add Component" width="0" height="0"></a>
