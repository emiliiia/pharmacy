...
<div class="mainGroundwork">
    ...
    <div class="titleComponentDIV">
        <h1 id="titleComponent">Add role form</h1>
    </div>
    <div style="height: 400px" class="AddContainer">
        <div class="brand-logoClient"></div>
        <div class="brand-title">Role</div>
        <form name="role" action="endCreateForm" method="post">
            <div class="inputs">
                <label>Role</label>
                <@spring.formInput "form.rolename" "required" />
                <form action="http://localhost:8082/ui/v1/postgreeSQL/role/endCreateForm">
