...
<div class="mainGroundwork">
    ...
    <div class="titleComponentDIV">
        <h1 id="titleComponent">Roles table</h1>
    </div>
    <table style="margin-top: -2px" class="table">
        <thead>
        <tr>
            <th>№</th>
            <th style="padding-left: 70px; padding-right: 70px;">Role</th>
            <th></th>
        </tr>
        </thead>
        <#list roles as role>
        ...
        <tr id="ququ">
            <td></td>
            <td style="height: 30px">${role.rolename}</td>
            <td  style="background: #196a6a">
                <a href=""></a>
              <!--  <a style="margin-left: 50px;" href="http://localhost:8082/ui/v1/postgreeSQL/role/delete/{role.id}"><img id="rot" src="<spring.url '/css/siteStyle/delete.png'/>" alt="" width="45" height="45"></a>-->
            </td>
        </tr>
        </#list>
        </tbody>
