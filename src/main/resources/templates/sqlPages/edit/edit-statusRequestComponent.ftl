...
<div class="mainGroundwork">
    ...
    <div class="titleComponentDIV">
        <h1 id="titleComponent">Update request status form</h1>
    </div>
    <div style="height: 550px" class="AddContainer">
        <div class="brand-logoRequestComponent"></div>
        <div class="brand-title">Request</div>
        <form name="requestComponent" action="" method="post">
            <div class="inputs">
                <label>COMPONENT</label>
                <@spring.formInput "form.componentId" "readonly"/>
                <label>STATUS</label>
                <div class="select">
                    <@spring.formSingleSelect "form.status", status "select"/>
                </div>
                <label>QUANTITY</label>
                <@spring.formInput "form.requestQuantity" "readonly" />
                <form action="">
                    <button type="submit">UPDATE REQUEST STATUS</button>
                </form>
            </div>
        </form>
    </div>
