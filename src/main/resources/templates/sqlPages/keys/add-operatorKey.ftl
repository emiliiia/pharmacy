...
<div class="mainGroundwork">
    ...
    <div class="titleComponentDIV">
        <h1 id="titleComponent">Add operator key form</h1>
    </div>
    <div style="height: 500px" class="AddContainer">
        <div class="brand-logoClient"></div>
        <div class="brand-title">Operator</div>
        <form name="key" action="endCreateOperatorForm" method="post">
            <div class="inputs">
                <label>LOGIN</label>
                <@spring.formInput "form.username" "required" />
                <label>PASSWORD</label>
                <@spring.formInput "form.password" "required" />
                <form action="http://localhost:8082/ui/v1/postgreeSQL/key/endCreateOperatorForm">
