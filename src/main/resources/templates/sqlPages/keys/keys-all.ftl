...
<div class="mainGroundwork">
    ...
    <ul class="dropdown">
        <li><a href="#">Create</a>
            <ul>
                <li><a href="http://localhost:8082/ui/v1/postgreeSQL/key/createOwnerForm">Owner</a></li>
                <li><a href="http://localhost:8082/ui/v1/postgreeSQL/key/createAdminForm">Admin</a></li>
                <li><a href="http://localhost:8082/ui/v1/postgreeSQL/key/createOperatorForm">Operator</a></li>
                <li><a href="http://localhost:8082/ui/v1/postgreeSQL/key/createUserForm">User</a></li>
            </ul>
        </li>
    </ul>
    <br><br><br><br><br>
       <div class="titleComponentDIV">
        <h1 id="titleComponent">Keys table</h1>
    </div>
    <table style="margin-top: -2px" class="table">
        <thead>
        <tr>
            <th>№</th>
            <th style="padding-left: 70px; padding-right: 70px;">Login</th>
            <th>Password</th>
            <th>Role</th>
            <th>Actions</th>
        </tr>
        ...
        <tr id="ququ">
            ...
            <td>${key.username}</td>
            <td>${key.password}</td>
            <td>${key.role.rolename}</td>
            <td  style="background: #196a6a">
                <a style="position:absolute;" href="http://localhost:8082/ui/v1/postgreeSQL/key/editForm/${key.id}"><img id="rot" src="<@spring.url '/css/siteStyle/edit.png'/>" alt="" width="45" height="45"></a>
                <a style="margin-left: 50px;" href="http://localhost:8082/ui/v1/postgreeSQL/key/delete/${key.id}"><img id="rot" src="<@spring.url '/css/siteStyle/delete.png'/>" alt="" width="45" height="45"></a>
            </td>
        </tr>
        </#list>
        </tbody>
