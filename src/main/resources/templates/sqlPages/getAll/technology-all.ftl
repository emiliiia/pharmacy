...
<div class="mainGroundwork">
    ...
    <ul class="dropdown">
        <li><a href="#">Sort By</a>
            <ul>
                <li><a href="">Name</a>
                    <ul>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/technologyBook/sortNameAsce">ascending&nbsp;&nbsp;&nbsp;▲</a></li>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/technologyBook/sortNameDsce">descending ▼</a></li>
                    </ul>
                </li>
                <li><a href="">Method</a>
                    <ul>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/technologyBook/sortMethodDISSOLVING">Dissolving</a></li>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/technologyBook/sortMethodSWELLING">Swelling</a></li>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/technologyBook/sortMethodHEATING">Heating</a></li>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/technologyBook/sortMethodDILUTION">Dilution</a></li>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/technologyBook/sortMethodFILTERING">Filtering</a></li>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/technologyBook/sortMethodEMULSIFYING">Emulsifying</a></li>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/technologyBook/sortMethodDISPERSING">Dispersing</a></li>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/technologyBook/sortMethodMIXING">Mixing</a></li>
                    </ul>
                </li>
                <li><a href="">Created at</a>
                    <ul>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/technologyBook/sortCreatedAtAsce">ascending&nbsp;&nbsp;&nbsp;▲</a></li>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/technologyBook/sortCreatedAtDsce">descending ▼</a></li>
                    </ul>
                </li>
                <li><a href="">Updated at</a>
                    <ul>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/technologyBook/sortUpdatedAtAsce">ascending&nbsp;&nbsp;&nbsp;▲</a></li>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/technologyBook/sortUpdatedAtDsce">descending ▼</a></li>
                    </ul>
                </li>
            </ul>
        </li>
    ...
    <br><br><br><br><br>
    <a style="height: 45px;margin-left:1150px" id="addIcon" href="http://localhost:8082/ui/v1/postgreeSQL/technologyBook/createForm"><img style="" id="rot" src="<@spring.url '/css/siteStyle/iconAdd.png'/>" alt="Add Technology" width="45" height="45"></a>
    ...
    <table style="margin-top: -2px" class="table">
        ...
        <tr id="ququ">
            ...
            <td  style="background: #196a6a">
                <a style="position:absolute;" href="http://localhost:8082/ui/v1/postgreeSQL/technologyBook/editForm/${technology.id}"><img id="rot" src="<@spring.url '/css/siteStyle/edit.png'/>" alt="" width="45" height="45"></a>
                <a style="margin-left: 50px;" href="http://localhost:8082/ui/v1/postgreeSQL/technologyBook/delete/${technology.id}"><img id="rot" src="<@spring.url '/css/siteStyle/delete.png'/>" alt="" width="45" height="45"></a>
            </td>
        </tr>
        </#list>
        </tbody>
