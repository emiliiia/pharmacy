...
<div class="mainGroundwork">
    ...
    <ul class="dropdown">
        <li><a href="#">Sort By</a>
            <ul>
                <li><a href="">Name</a>
                    <ul>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/officinal/drugs/sortOfficinalNameAsce">ascending&nbsp;&nbsp;&nbsp;▲</a></li>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/officinal/drugs/sortOfficinalNameDsce">descending ▼</a></li>
                    </ul>
                </li>
                <li><a href="">Created at</a>
                    <ul>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/officinal/drugs/sortOfficinalCreatedAtAsce">ascending&nbsp;&nbsp;&nbsp;▲</a></li>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/officinal/drugs/sortOfficinalCreatedAtDsce">descending ▼</a></li>
                    </ul>
                </li>
                <li><a href="">Updated at</a>
                    <ul>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/officinal/drugs/sortOfficinalUpdatedAtAsce">ascending&nbsp;&nbsp;&nbsp;▲</a></li>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/officinal/drugs/sortOfficinalUpdatedAtDsce">descending ▼</a></li>
                    </ul>
                </li>
                <li><a href="">Use</a>
                    <ul>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/officinal/drugs/sortOfficinalUseExternal">External</a></li>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/officinal/drugs/sortOfficinalUseInternal">Internal</a></li>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/officinal/drugs/sortOfficinalUseExInternal">External-Internal</a></li>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/officinal/drugs/sortOfficinalUseMix">Mix</a></li>
                    </ul>
                </li>
                <li><a href="">Form</a>
                    <ul>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/officinal/drugs/sortOfficinalFormTablets">Tablets</a></li>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/officinal/drugs/sortOfficinalFormOintment">Ointment</a></li>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/officinal/drugs/sortOfficinalFormTincture">Tincture</a></li>
                    </ul>
                </li>
                <li><a href="">In Stock</a>
                    <ul>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/officinal/drugs/sortOfficinalInStockAsce">ascending&nbsp;&nbsp;&nbsp;▲</a></li>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/officinal/drugs/sortOfficinalInStockDsce">descending ▼</a></li>
                    </ul>
                </li>
                <li><a href="http://localhost:8082/ui/v1/postgreeSQL/officinal/drugs/expireDrugs">Expired</a></li>
            </ul>
        </li>
    </ul>
    ...
    <div class="titleComponentDIV">
        <h1 id="titleComponent">Officinal drugs table</h1>
    </div>
    <table style="margin-top: -2px; margin-left: -55px;" class="table">
        ...
        <tr id="ququ" class="ququ2">
            ...
            <td>${drug.price} $</td>
            <td><a style="font-size: 16px; color: #fedac4; text-decoration: none" href="http://localhost:8082/ui/v1/postgreeSQL/manufacturers/review/${drug.manufacturerId.id}">${drug.manufacturerId.manufacturerName}</a></td>
            <td  style="background: #0f4040">
                <a style="position:absolute;" href="http://localhost:8082/ui/v1/postgreeSQL/officinal/drugs/editForm/${drug.id}"><img id="rot" src="<@spring.url '/css/siteStyle/edit.png'/>" alt="" width="45" height="45"></a>
                <a style="margin-left: 50px;" href="http://localhost:8082/ui/v1/postgreeSQL/officinal/drugs/delete/${drug.id}"><img id="rot" src="<@spring.url '/css/siteStyle/delete.png'/>" alt="" width="45" height="45"></a>
                <a style="position: relative; margin-left: 0px;" href="http://localhost:8082/ui/v1/postgreeSQL/officinal/drugs/review/${drug.id}"><img id="rot" src="<@spring.url '/css/siteStyle/iconInform.png'/>" alt="" width="40" height="40"></a>
            </td>
        </tr>
        </#list>
        </tbody>
