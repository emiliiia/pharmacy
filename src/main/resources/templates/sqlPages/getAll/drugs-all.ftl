...
<div class="mainGroundwork">
    ...
    <ul class="dropdown">
        <li><a href="#">Sort By</a>
            <ul>
                <li><a href="">Name</a>
                    <ul>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/drugs/sortNameAsce">ascending&nbsp;&nbsp;&nbsp;▲</a></li>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/drugs/sortNameDsce">descending ▼</a></li>
                    </ul>
                </li>
                <li><a href="">Created at</a>
                    <ul>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/drugs/sortCreatedAtAsce">ascending&nbsp;&nbsp;&nbsp;▲</a></li>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/drugs/sortCreatedAtDsce">descending ▼</a></li>
                    </ul>
                </li>
                <li><a href="">Updated at</a>
                    <ul>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/drugs/sortUpdatedAtAsce">ascending&nbsp;&nbsp;&nbsp;▲</a></li>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/drugs/sortUpdatedAtDsce">descending ▼</a></li>
                    </ul>
                </li>
                <li><a href="">Use</a>
                    <ul>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/drugs/sortUseExternal">External</a></li>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/drugs/sortUseInternal">Internal</a></li>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/drugs/sortUseExInternal">External-Internal</a></li>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/drugs/sortUseMix">Mix</a></li>
                    </ul>
                </li>
                <li><a href="">Form</a>
                    <ul>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/drugs/sortFormTablets">Tablets</a></li>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/drugs/sortFormOintment">Ointment</a></li>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/drugs/sortFormPotion">Potion</a></li>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/drugs/sortFormAQUA">Aqua</a></li>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/drugs/sortFormFlour">Flour</a></li>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/drugs/sortFormTincture">Tincture</a></li>
                    </ul>
                </li>
                <li><a href="http://localhost:8082/ui/v1/postgreeSQL/orders/sortTopTenDrugs">Top-10 drugs</a></li>
            </ul>
        </li>
    </ul>
    <br><br><br><br><br>
    ...
    <div class="titleComponentDIV">
        <h1 id="titleComponent">Drugs table</h1>
    </div>
    <table style="margin-top: -2px; margin-left: -55px;" class="table">
        ...
        <tr id="ququ" class="ququ2">
            ...
            <td  style="background: #0f4040">
                <a style="margin-left: 0px;" href="http://localhost:8082/ui/v1/postgreeSQL/extemporal/drugs/delete/${drug.id}"><img id="rot" src="<@spring.url '/css/siteStyle/delete.png'/>" alt="" width="45" height="45"></a>
            </td>
        </tr>
        </#list>
        </tbody>
