...
<div class="mainGroundwork">
    ...
    <ul class="dropdown">
        <li><a href="#">Sort By</a>
            <ul>
                <li><a href="">Name</a>
                    <ul>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/requestComponents/sortNameAsce">ascending&nbsp;&nbsp;&nbsp;▲</a></li>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/requestComponents/sortNameDsce">descending ▼</a></li>
                    </ul>
                </li>
                <li><a href="">Created at</a>
                    <ul>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/requestComponents/sortCreatedAtAsce">ascending&nbsp;&nbsp;&nbsp;▲</a></li>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/requestComponents/sortCreatedAtDsce">descending ▼</a></li>
                    </ul>
                </li>
                <li><a href="">Updated at</a>
                    <ul>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/requestComponents/sortUpdatedAtAsce">ascending&nbsp;&nbsp;&nbsp;▲</a></li>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/requestComponents/sortUpdatedAtDsce">descending ▼</a></li>
                    </ul>
                </li>
                <li><a href="#">Status</a>
                    <ul>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/requestComponents/sortStatusInprogress">In Progress</a></li>
                        <li><a href="http://localhost:8082/ui/v1/postgreeSQL/requestComponents/sortStatusGotten">Gotten</a></li>
                    </ul>
                </li>
            </ul>
        </li>
    ...
    <br><br><br><br><br>
    <a style="height: 45px;margin-left:1150px" id="addIcon" href="http://localhost:8082/ui/v1/postgreeSQL/requestComponents/createForm"><img style="" id="rot" src="<@spring.url '/css/siteStyle/iconAdd.png'/>" alt="Add Request" width="45" height="45"></a>
    <div class="titleComponentDIV">
        <h1 id="titleComponent">Request for components table</h1>
    </div>
    <table style="margin-top: -2px" class="table">
        <thead>
        <tr>
            <th>№</th>
            <th style="padding-left: 70px; padding-right: 70px;">Component name</th>
            <th>Quantity</th>
            <th>Status ⚙️</th>
            <th>Created At</th>
            <th>Updated At</th>
        ...
        <#list requestComponents as requestComponent>
        <tbody>
        <tr id="ququ" class="ququ2">
            <td></td>
            <td><a style="font-size: 16px; color: #fedac4; text-decoration: none" href="http://localhost:8082/ui/v1/postgreeSQL/components/review/${requestComponent.componentId.id}">${requestComponent.componentName}</a></td>
            <td>${requestComponent.requestQuantity}</td>
            <td><a style="font-size: 16px; color: #fedac4; text-decoration: none" href="http://localhost:8082/ui/v1/postgreeSQL/requestComponents/editStatusForm/${requestComponent.id}">${requestComponent.status}</a></td>
            <td>${requestComponent.createdAt}</td>
            <td>${requestComponent.updatedAt}</td>
            <td  style="background: #196a6a">
                <a style="position:absolute;" href="http://localhost:8082/ui/v1/postgreeSQL/requestComponents/editForm/${requestComponent.id}"><img id="rot" src="<@spring.url '/css/siteStyle/edit.png'/>" alt="" width="45" height="45"></a>
                <a style="margin-left: 50px;" href="http://localhost:8082/ui/v1/postgreeSQL/requestComponents/delete/${requestComponent.id}"><img id="rot" src="<@spring.url '/css/siteStyle/delete.png'/>" alt="" width="45" height="45"></a>
            </td>
        </tr>
        </#list>
        </tbody>
